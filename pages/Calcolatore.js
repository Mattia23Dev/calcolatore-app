  ...
  return (
    <div className="calcolatore-container">
        ...
        <div className='calcolatore-intro'>
            <img alt='intro' src={images.img10} />
